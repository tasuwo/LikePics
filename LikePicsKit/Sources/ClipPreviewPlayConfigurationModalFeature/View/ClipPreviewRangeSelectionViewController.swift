...
public class ClipPreviewRangeSelectionViewController: UIViewController {
    // MARK: - Properties
    ...
    override public func viewDidLoad() {
        ...
        title = L10n.Root.MenuTitle.range
...
extension ClipPreviewRangeSelectionViewController {
    ...
    private func configureDataSource() {
        ...
        snapshot.appendItems([.overall, .clip])
...
extension ClipPreviewRangeSelectionViewController: UICollectionViewDelegate {
...
extension ClipPreviewRangeSelectionViewController {
    ...
    enum Layout {
        ...
        typealias Item = ClipPreviewPlayConfiguration.Range
