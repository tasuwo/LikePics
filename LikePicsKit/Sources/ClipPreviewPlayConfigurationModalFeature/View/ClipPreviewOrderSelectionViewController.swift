...
public class ClipPreviewOrderSelectionViewController: UIViewController {
    // MARK: - Properties
    ...
    override public func viewDidLoad() {
        ...
        title = L10n.Root.MenuTitle.order
...
extension ClipPreviewOrderSelectionViewController: UICollectionViewDelegate {
...
extension ClipPreviewOrderSelectionViewController {
    enum Layout {
        ...
        typealias Item = ClipPreviewPlayConfiguration.Order
