...
public class ClipItemContentView: UIView {
    public static var nib: UINib {
        return UINib(nibName: "ClipItemCell", bundle: Bundle.module)
    }
...
extension ClipItemContentView {
    private func setupFromNib() {
        Bundle.module.loadNibNamed("ClipItemContentView", owner: self, options: nil)
    ...
    func apply(_ configuration: ClipItemContentConfiguration) {
        ...
        if configuration.imageSize != .zero {
