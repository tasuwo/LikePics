...
public protocol ClipStorageProtocol {
    ...
    func updateClip(having clipId: Clip.Identity, byReplacingAlbumsHaving albumIds: [Album.Identity]) -> Result<Void, ClipStorageError>
    ...
    func deleteClip(having id: Clip.Identity) -> Result<Clip, ClipStorageError>
