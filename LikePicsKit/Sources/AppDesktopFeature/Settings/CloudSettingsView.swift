    ...
    var body: some View {
        Form {
            VStack(alignment: .leading, spacing: 8) {
                Toggle(String(localized: "iCloud Sync", bundle: .module, comment: "Toggle title for icloud sync setting"), isOn: .init(get: {
        ...
        .alert(Text("Turn off iCloud Sync", bundle: .module, comment: "Alert title"),
        ...
        .alert(Text("iCloud Unavailable", bundle: .module, comment: "Alert title"),
