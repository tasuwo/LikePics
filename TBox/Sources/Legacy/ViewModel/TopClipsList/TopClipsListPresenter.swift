...
class TopClipCollectionPresenter {
    ...
    private(set) var clips: CurrentValueSubject<[Clip], Error>
    private var selections: CurrentValueSubject<Set<Clip.Identity>, Never>

    internal var selectedClips: [Clip] {
