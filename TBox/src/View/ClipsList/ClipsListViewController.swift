...
class ClipsListViewController: UIViewController {
    ...
    private let presenter: ClipsListPresenter
    ...
    init(factory: Factory, presenter: ClipsListPresenter, transitionController: ClipPreviewTransitionControllerProtocol) {
