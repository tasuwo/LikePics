...
class AlbumEditViewController: UIViewController, ClipsListEditable, ClipsListSynchronizable {
    typealias Factory = ViewControllerFactory
    typealias Presenter = AlbumEditPresenterProxy
    ...
    init(factory: Factory,
         presenter: AlbumEditPresenterProxy,
...
extension AlbumEditViewController: AlbumEditViewProtocol {
    // MARK: - AlbumEditViewProtocol
...
extension AlbumEditViewController: UICollectionViewDelegate {
...
extension AlbumEditViewController: UIScrollViewDelegate {
...
extension AlbumEditViewController: UICollectionViewDataSource {
...
extension AlbumEditViewController: ClipsCollectionLayoutDelegate {
